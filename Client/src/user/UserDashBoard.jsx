          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-white p-6 rounded-lg border border-neutral-200/20">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <h3 className="text-lg font-semibold text-neutral-900">8</h3>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg border border-neutral-200/20">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <h3 className="text-lg font-semibold text-neutral-900">4</h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="overflow-x-auto">
                    <table className="w-full">
                        ...
                        <tbody className="bg-white divide-y divide-neutral-200/20">
                            <tr>
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-900">#APP-001</td>
                            ...
                            <tr>
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-900">#APP-002</td>
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-600">Income Certificate</td>
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800">Pending</span>
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-600">2024-01-19</td>
                                <td className="px-6 py-4 whitespace-nowrap text-sm">
                                    <button className="text-blue-600 hover:text-blue-900">View Details</button>
                                </td>
                            </tr>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-lg border border-neutral-200/20">
                    ...
                    <button className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 transition duration-150">Apply Now</button>
                </div>
